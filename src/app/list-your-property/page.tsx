...
export default function ListYourPropertyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      ...
      <section className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 lg:p-6 mb-2">
        <p className="text-sm text-stone-700 mb-3">
          {locale === 'th' ? 'ไม่อยากกรอกฟอร์ม? แชทหาเราเลย เราจะช่วยลงให้' :
           locale === 'en' ? 'Don\'t want to fill the form? Chat with us — we\'ll list it for you.' :
           locale === 'zh' ? '不想填表？直接联系我们——我们帮您挂牌。' :
           'Не хотите заполнять форму? Напишите нам — мы всё сделаем.'}
        </p>
