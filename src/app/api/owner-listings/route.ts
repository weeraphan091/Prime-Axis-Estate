...
export async function POST(request: Request) {
  ...
  try {
    ...
    const payload = {
      ...
      rentMinLease: body.listingType === 'rent' && body.rentMinLease ? Number(body.rentMinLease) : undefined,
      ...
      originalPrice: body.listingType === 'sale' && body.originalPrice ? Number(body.originalPrice) : undefined,
      quotaType: body.listingType === 'sale' && (body.propertyType === 'condo' || body.propertyType === 'apartment') && body.quotaType ? String(body.quotaType) : undefined,
