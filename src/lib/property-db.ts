...
export function prismaToProperty(p: PrismaPropertyRow): Property {
  ...
  return {
    ...
    rentMinLease: (p as Record<string, unknown>).rentMinLease as number | undefined ?? undefined,
    rentLeaseStart: p.rentLeaseStart ?? undefined,
    rentLeaseEnd: p.rentLeaseEnd ?? undefined,
    originalPrice: (p as Record<string, unknown>).originalPrice as number | undefined ?? undefined,
    quotaType: ((p as Record<string, unknown>).quotaType === 'TH' || (p as Record<string, unknown>).quotaType === 'FQ') ? (p as Record<string, unknown>).quotaType as 'TH' | 'FQ' : undefined,
